...
def run_exp(train_loader,val_loader):
    ...
    l2_lambda = 1e-4  # For L2 regularization (weight decay)
...
def load_model_for_eval():
    ...
    model_path = '/home/workspace/files/MilanK/Model1/final_models/final_resp_models/dynamic_only/dynamic_only.pth'          
